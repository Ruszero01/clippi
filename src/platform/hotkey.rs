...
mod macos {
    ...
    fn detect_pressed_key() -> Option<Code> {
        ...
        let vk_map: &[(u16, Code)] = &[
            // Letters
            (0x00, Code::KeyA), (0x01, Code::KeyS), (0x02, Code::KeyD),
            (0x03, Code::KeyF), (0x04, Code::KeyH), (0x05, Code::KeyG),
            (0x06, Code::KeyZ), (0x07, Code::KeyX), (0x08, Code::KeyC),
            (0x09, Code::KeyV), (0x0B, Code::KeyB), (0x0C, Code::KeyQ),
            (0x0D, Code::KeyW), (0x0E, Code::KeyE), (0x0F, Code::KeyR),
            (0x10, Code::KeyY), (0x11, Code::KeyT), (0x12, Code::Digit1),
            (0x13, Code::Digit2), (0x14, Code::Digit3), (0x15, Code::Digit4),
            (0x16, Code::Digit6), (0x17, Code::Digit5), (0x18, Code::Equal),
            (0x19, Code::Digit9), (0x1A, Code::Digit7), (0x1B, Code::Minus),
            (0x1C, Code::Digit8), (0x1D, Code::Digit0),
            (0x1E, Code::BracketRight), (0x1F, Code::KeyO),
            (0x20, Code::KeyU), (0x21, Code::BracketLeft),
            (0x22, Code::KeyI), (0x23, Code::KeyP),
            (0x25, Code::KeyL), (0x26, Code::KeyJ),
            (0x27, Code::Quote), (0x28, Code::KeyK),
            (0x29, Code::Semicolon), (0x2A, Code::Backslash),
            (0x2B, Code::Comma), (0x2C, Code::Slash),
            (0x2D, Code::KeyN), (0x2E, Code::KeyM),
            (0x2F, Code::Period),
            // Special keys
            ...
            // Function keys
            (0x7A, Code::F1), (0x78, Code::F2), (0x63, Code::F3),
            (0x76, Code::F4), (0x60, Code::F5), (0x61, Code::F6),
            (0x62, Code::F7), (0x64, Code::F8), (0x65, Code::F9),
            (0x6D, Code::F10), (0x67, Code::F11), (0x6F, Code::F12),
        ];
