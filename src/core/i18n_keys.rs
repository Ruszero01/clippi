...
define_i18n! {
    ...
    SettingQuickSyncFilters: ("同步筛选状态", "Sync filters"),
    DescQuickSyncFiltersOn:  ("与主窗口共用标签、类型和收藏筛选", "Share the tag, type and favorite filters with the main window"),
    DescQuickSyncFiltersOff: ("快速窗口单独维护自己的筛选", "The quick window keeps its own filters"),
    ...
    // ─── Font settings ───
    SettingFontSize:     ("字号", "Font size"),
    DescFontSize:        ("整体缩放界面文字，保留层级比例", "Scale all text, keeping the type hierarchy"),
    FontSizeCompact:     ("紧凑", "Compact"),
    FontSizeStandard:    ("标准", "Standard"),
    FontSizeLarge:       ("宽松", "Comfort"),
    FontSizeXLarge:      ("特大", "Large"),
    SettingFontFamily:   ("字体", "Font"),
    DescFontFamily:      ("选择界面字体，中英文自动回退", "Pick the UI font; CJK/Latin auto-fallback"),

    // ─── Settings group titles ───
    GroupStartup:       ("启动", "Startup"),
    GroupWindow:        ("窗口行为", "Window behavior"),
    GroupAppearance:    ("外观", "Appearance"),
    GroupLanguage:      ("语言与区域", "Language"),
    GroupPosition:      ("窗口位置", "Window position"),
    GroupQuickWindow:   ("快速粘贴窗口", "Quick paste window"),
    GroupListDisplay:   ("列表与显示", "List & display"),
    GroupCardLayout:    ("卡片布局", "Card layout"),
    GroupContentDetect: ("内容识别", "Content detection"),
    GroupCopyPaste:     ("复制与粘贴", "Copy & paste"),
    GroupSound:         ("提示音", "Sound"),
    GroupFiltering:     ("过滤与排除", "Filtering"),
    GroupHotkeys:       ("全局快捷键", "Global hotkeys"),
    GroupWinVTakeover:  ("系统快捷键接管", "System hotkey takeover"),
    GroupHotkeyLists:   ("列表与排除", "Lists & exclusions"),
    GroupStorage:       ("存储位置", "Storage location"),
    GroupRetention:     ("数据保留", "Data retention"),
    GroupCleanup:       ("缓存清理", "Cache cleanup"),
    GroupDanger:        ("危险操作", "Danger zone"),
    GroupSyncMaster:    ("同步设置", "Sync settings"),
    GroupSyncOptions:   ("同步内容", "Synced content"),
    GroupTransfer:      ("中转站", "Transfer station"),
    GroupConfigSync:    ("配置同步", "Config sync"),
    GroupBackends:      ("同步后端", "Sync backends"),
    GroupUpdate:        ("更新", "Updates"),
    FontFamilySystem:    ("系统默认", "System"),
    FontFamilyPicker:    ("选择字体", "Choose a font"),
    FontFamilySample:    ("中文字体 Aa", "Aa 字体"),
    ...
    LatestHotkeysConfigured: ("已设置 {0}/10", "{0}/10 set"),
    ...
    EditContentIsFileEntry:("该内容已作为文件或图片条目存在", "Already exists as a file or image entry"),
